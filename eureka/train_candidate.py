...
Runs a short PPO training run for ONE reward candidate, reusing the exact
same ActorCritic / RolloutBuffer / PPOAgent classes as the main train.py -
just with a smaller env count and a shorter timestep budget, since the
