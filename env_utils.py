...
class _EnvFactory:
    ...
    def __call__(self):
        ...
        llm_judge_fn = None
        if USE_LLM_JUDGE:
            # BROKEN ORPHAN PATH: llm_judge.py was removed (see CHANGELOG /
            # docs/DOC_AUDIT.md). This import will raise ImportError.
            # Kept intentionally so callers notice rather than silently
            # dropping judge behavior. Do not enable USE_LLM_JUDGE.
            from functools import partial
            from llm_judge import judge_episode  # noqa: F401 — module missing
